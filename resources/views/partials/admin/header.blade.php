      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-8">
            ...
            <a href="#" class="border-b border-transparent text-gray-400 hover:text-gray-100 py-4 font-medium">文章</a>
            <a href="#" class="border-b border-transparent text-gray-400 hover:text-gray-100 py-4 font-medium">留言</a>
            <a href="#" class="border-b border-transparent text-gray-400 hover:text-gray-100 py-4 font-medium">附件</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
