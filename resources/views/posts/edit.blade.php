      ...
      <x-form action="{{ route('posts.update', $post) }}" method="put">
        <div class="flex flex-wrap -mx-4">
          <div class="flex-1 px-4">
            ...
            <x-form.filepond label="封面" name="cover" value="{{ $post->cover }}" placeholder="PNG, JPG, GIF 格式的图片不能超过 10MB"></x-form.filepond>
          ...
          <div class="w-full sm:w-1/4 px-4">
            ...
            <x-form.flatpickr label="发布时间" name="published_at" value="{{ $post->published_at }}" placeholder="请输入发布时间"></x-form.flatpickr>
